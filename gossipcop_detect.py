...
post_nodes = data_loader(pathway='data/processed_data/FakeNewsNet/GossipCop/batch/normalized_post_nodes/',
                         node_type="post")
user_nodes = data_loader(pathway='data/processed_data/FakeNewsNet/GossipCop/batch/normalized_user_nodes/',
                         node_type="user")
news_nodes = data_loader(pathway='data/processed_data/FakeNewsNet/GossipCop/batch/normalized_news_nodes/',
                         node_type="news")
news_emb_dict = {}
post_emb_dict = {}
user_emb_dict = {}
...
class HetTransformer(nn.Module):
    ...
    def __init__(self, input_dim, ini_hidden_dim, hidden_dim,
        ...
        self.transformer = nn.Transformer(d_model=d_model, nhead=attn_heads, num_encoder_layers=enc_layers,
                                          num_decoder_layers=6, dim_feedforward=feed_forward,
    ...
    def transformer_agg(self, het_node, neighbor_order_n_p_u, neighbor_order_n, npu=30,
...
def load_train_test(data_real, data_fake, test_index_path_real='models/data_splits/GossipCop/test_index_real.txt',
                    test_index_path_fake='models/data_splits/GossipCop/test_index_fake.txt'):
